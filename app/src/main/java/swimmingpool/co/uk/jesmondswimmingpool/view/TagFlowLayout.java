...
public class TagFlowLayout extends FlowLayout
        implements swimmingpool.co.uk.jesmondswimmingpool.view.TagAdapter.OnDataChangedListener {

    private swimmingpool.co.uk.jesmondswimmingpool.view.TagAdapter mTagAdapter;
    ...
    public void setOnLongTagClickListener(OnTagLongClickListener mOnTagLongClickListener){
    ...
    public void setAdapter(swimmingpool.co.uk.jesmondswimmingpool.view.TagAdapter adapter) {
        mTagAdapter = adapter;
    ...
    private void changeAdapter() {
        removeAllViews();
        swimmingpool.co.uk.jesmondswimmingpool.view.TagAdapter adapter = mTagAdapter;
            ...
            tagViewContainer.setOnLongClickListener(new OnLongClickListener() {
                ...
                public boolean onLongClick(View view) {
                    if(mOnTagLongClickListener!=null){
                        return mOnTagLongClickListener.onTagLongClick(finalTagViewContainer,position,TagFlowLayout.this);
                    }
                    return false;
                }
            });
    ...
    public swimmingpool.co.uk.jesmondswimmingpool.view.TagAdapter getAdapter() {
        return mTagAdapter;
    }
