...
public class CustomHeader extends RelativeLayout implements RefreshHeader {
    ...
    public static String REFRESH_HEADER_PULLDOWN = "pull to refresh";
    public static String REFRESH_HEADER_REFRESHING = "refreshing...";
    public static String REFRESH_HEADER_LOADING = "loading...";
    public static String REFRESH_HEADER_RELEASE = "release to refresh";
    public static String REFRESH_HEADER_FINISH = "refresh complete";
    public static String REFRESH_HEADER_FAILED = "refresh failure";
    ...
    protected DateFormat mFormat = new SimpleDateFormat(REFRESH_HEADER_LASTTIME, Locale.UK);
...
//    }
    ...
    public CustomHeader setLastUpdateTime(Date time) {
        mLastTime = time;
        mLastUpdateText.setText("last update:"+mFormat.format(time));
    ...
    public CustomHeader setTimeFormat(DateFormat format) {
        mFormat = format;
        mLastUpdateText.setText("last update:"+mFormat.format(mLastTime));
        return this;
    }
