package swimmingpool.co.uk.jesmondswimmingpool.view;
...
public  class CustomFooter extends RelativeLayout implements RefreshFooter {
    ...
    public static String REFRESH_FOOTER_PULLUP = "load more...";
    public static String REFRESH_FOOTER_RELEASE = "release to load";
    ...
    public static String REFRESH_FOOTER_FAILED = "load failure";
    public static String REFRESH_FOOTER_ALLLOADED = "all loaded";
    ...
    private void initView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        RelativeLayout.LayoutParams lpBottomText = new RelativeLayout.LayoutParams(WRAP_CONTENT, WRAP_CONTENT);
...
//    }
    ...
    public CustomFooter setProgressBitmap(Bitmap bitmap) {
        mProgressDrawable = null;
        mProgressView.setImageBitmap(bitmap);
        return this;
    }
    public CustomFooter setProgressDrawable(Drawable drawable) {
        mProgressDrawable = null;
        mProgressView.setImageDrawable(drawable);
        return this;
    }
    public CustomFooter setProgressResource(@DrawableRes int resId) {
        mProgressDrawable = null;
        mProgressView.setImageResource(resId);
        return this;
    }
    public CustomFooter setArrowBitmap(Bitmap bitmap) {
        mArrowDrawable = null;
        mArrowView.setImageBitmap(bitmap);
        return this;
    }
    public CustomFooter setArrowDrawable(Drawable drawable) {
        mArrowDrawable = null;
        mArrowView.setImageDrawable(drawable);
        return this;
    }
    public CustomFooter setArrowResource(@DrawableRes int resId) {
        mArrowDrawable = null;
        mArrowView.setImageResource(resId);
        return this;
    }
    public CustomFooter setSpinnerStyle(SpinnerStyle style) {
    ...
    public CustomFooter setPrimaryColorId(@ColorRes int colorId) {
        setPrimaryColor(ContextCompat.getColor(getContext(), colorId));
        return this;
    }

    public CustomFooter setAccentColorId(@ColorRes int colorId) {
        setAccentColor(ContextCompat.getColor(getContext(), colorId));
        return this;
    }

    public CustomFooter setFinishDuration(int delay) {
        mFinishDuration = delay;
        return this;
    }

    public CustomFooter setTextSizeTitle(float size) {
    ...
    public CustomFooter setTextSizeTitle(int unit, float size) {
    ...
    public CustomFooter setDrawableMarginRight(float dp) {
        return setDrawableMarginRightPx(DensityUtil.dp2px(dp));
    }

    public CustomFooter setDrawableMarginRightPx(int px) {
    ...
    public CustomFooter setDrawableSize(float dp) {
        return setDrawableSizePx(DensityUtil.dp2px(dp));
    }

    public CustomFooter setDrawableSizePx(int px) {
    ...
    public CustomFooter setDrawableArrowSize(float dp) {
        return setDrawableArrowSizePx(DensityUtil.dp2px(dp));
    }

    public CustomFooter setDrawableArrowSizePx(int px) {
        ViewGroup.LayoutParams lpArrow = mArrowView.getLayoutParams();
        lpArrow.width = px;
        lpArrow.height = px;
        mArrowView.setLayoutParams(lpArrow);
    ...
    public CustomFooter setDrawableProgressSize(float dp) {
        return setDrawableProgressSizePx(DensityUtil.dp2px(dp));
    }

    public CustomFooter setDrawableProgressSizePx(int px) {
        ViewGroup.LayoutParams lpProgress = mProgressView.getLayoutParams();
        lpProgress.width = px;
